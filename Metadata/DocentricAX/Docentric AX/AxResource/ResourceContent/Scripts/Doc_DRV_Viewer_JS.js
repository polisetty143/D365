...
/***/ (function (module, exports, __webpack_require__) {
    ...
    function getPDFFileNameFromURL(url) {
        // DOCENTRIC FIX
        var fileName = getQuery("fileName");
...
/***/ (function (module, exports, __webpack_require__) {
    ...
    function configure(PDFJS) {
        ...
        PDFJS.workerSrc = '../scripts/Doc_DRV_PdfWorker_JS.js';
    ...
    var validateFileURL = void 0;
    {
        ...
        validateFileURL = function validateFileURL(file) {
            ...
            try {
                ...
                // DOCENTRIC FIX: The following validation doesn't work for Blob Urls (e.g. "blob:E3456..." in IE11).
...
/***/ (function (module, exports, __webpack_require__) {
    ...
    function renderPage(activeServiceOnEntry, pdfDocument, pageNumber, size) {
        ...
        //<DOCENTRIC> improved print quality to minimal acceptable (higher DPI increase the printing time, memory and amount of data sent to printer)
        var PRINT_RESOLUTION = 200;
        ...
        performPrint: function performPrint() {
            ...
            return new Promise(function (resolve) {
                setTimeout(function () {
                    ...
                    //<DOCENTRIC> fixed IE printing bug as proposed in https://github.com/mozilla/pdf.js/issues/8052
                    //print.call(window);
