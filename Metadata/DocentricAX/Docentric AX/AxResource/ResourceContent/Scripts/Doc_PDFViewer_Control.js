    ...
    var controllerInitializer = function (control, data, element) {
        ...
        function initializeViewerIFrame(documentBase64Strings) {
            ...
            if (useBrowserViewer)
                ...
                iFrameElement.src = "Resources/Html/Doc_PDFViewer.htm?file=" + fileUrl + "&locale=" + userLanguage + "&fileName=" + encodeURI(fileName) + "&enableExportToWord=" + enableExportToWord + "&enableExportToExcel=" + enableExportToExcel;
        }
